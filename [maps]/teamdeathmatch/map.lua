...
addTeamSpawn 'teamA' { x = 1195.5, y = -3033.94, z = 5.9, radius = 10.0 }
addTeamSpawn 'teamB' { x = 978.6, y = -3034.87, z = 5.9, radius = 10.0 }
...
addTeamEvent 'teamA' { on = 'haveScore', trigger = 'win', params = { value = 2000 } }
addTeamEvent 'teamB' { on = 'haveScore', trigger = 'win', params = { value = 2000 } }
